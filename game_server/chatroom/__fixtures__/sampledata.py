...
def get_sample_message_list():
    ...
    msg3 = MessageModel(user_id='125', user_name='johnny', content='I\'m fine, thanks', room='room1')
    msg4 = MessageModel(user_id='126', user_name='livvy', content='DADDY!', room='room1')
    msg5 = MessageModel(user_id='127', user_name='charlie_mae', content='I\'m hungry', room='room1')
